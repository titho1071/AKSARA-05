...
@include('components.navbar', ['role' => $role])
    ...
    <script>
        ...
        function downloadBulan() {
            ...
            pdfUrl = `/admin/absensi/rekap/preview?${params.toString()}`;;
        ...
        function downloadTribulan() {
            ...
            pdfUrl = `/admin/absensi/rekap/preview-3bulan?${params.toString()}`;;
        ...
        function downloadSemester() {
            ...
            pdfUrl = `/admin/absensi/rekap/preview-semester?${params.toString()}`;;
        ...
        function downloadTahun() {
            ...
            pdfUrl = `/admin/absensi/rekap/preview-tahun?${params.toString()}`;;
