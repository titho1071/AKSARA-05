...
<div class="mb-8">
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 px-4 py-2 pt-4">
        <div>
            <h1 class="text-3xl md:text-4xl font-bold text-gray-900">Edit Data Guru</h1>
...
<div class="rounded-[32px] border border-slate-200 bg-white p-8 shadow-sm">
    <form id="biodata-form" action="{{ route('admin.guru.update', $user->id) }}" method="POST" class="space-y-6">
        @csrf
        @method('PUT')
