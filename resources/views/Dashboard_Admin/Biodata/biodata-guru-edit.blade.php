...
<div class="mb-8">
    <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
            <p class="text-sm font-semibold text-slate-500">Edit Data Guru</p>
            <h1 class="text-3xl font-bold text-slate-950">Edit Data Guru</h1>
...
<div class="rounded-[32px] border border-slate-200 bg-white p-8 shadow-sm">
    <form action="{{ route('admin.guru.update', $user->id) }}" method="POST" class="space-y-6">
        @csrf
        @method('PUT')
