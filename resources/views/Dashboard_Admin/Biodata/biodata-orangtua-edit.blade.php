...
<div class="mb-8">
    <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
            <p class="text-sm font-semibold text-slate-500">Edit Data Orang Tua</p>
            <h1 class="text-3xl font-bold text-slate-950">Edit Data Orang Tua</h1>
            <p class="text-sm text-slate-500">Perbarui informasi data orang tua.</p>
        </div>
...
<div class="rounded-[32px] border border-slate-200 bg-white p-8 shadow-sm">
    <form action="{{ route('admin.orangtua.update', $user->id) }}" method="POST" class="space-y-6">
        @csrf
        @method('PUT')
