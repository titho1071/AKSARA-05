                        ...
                        <tr class="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-4 py-4">
                                <div class="flex items-center gap-2">
                                    <a href="/admin/pengumuman/${item.id_pengumuman}" class="flex items-center justify-center w-9 h-9 rounded-xl bg-blue-100 text-blue-600 hover:bg-blue-200 transition-colors" title="Detail">
                                    ...
                                    <a href="/admin/pengumuman/${item.id_pengumuman}/edit" class="flex items-center justify-center w-9 h-9 rounded-xl bg-yellow-100 text-yellow-600 hover:bg-yellow-200 transition-colors" title="Edit">
