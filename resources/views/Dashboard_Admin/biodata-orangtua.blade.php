...
@section('content')
    ...
    <div class="mb-8 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
            <p class="text-sm font-semibold text-slate-500">Biodata Orang Tua</p>
            <h1 class="text-3xl font-bold text-slate-950">Kelola Biodata Orang Tua</h1>
            <p class="text-sm text-slate-500">Lihat dan tambahkan data orang tua siswa.</p>
        </div>
    ...
    <div id="deleteModal" class="fixed inset-0 z-50 hidden items-center justify-center">
        ...
        <div class="relative w-full max-w-sm rounded-[28px] bg-white p-8 shadow-xl">
            ...
            <h2 class="mb-2 text-center text-lg font-bold text-slate-900">Hapus Orang Tua</h2>
            <p class="mb-1 text-center text-sm text-slate-500">Apakah kamu yakin ingin menghapus</p>
            <p id="deleteOrangTuaName" class="mb-6 text-center text-sm font-semibold text-slate-800"></p>
    ...
    <script>
        function confirmDelete(actionUrl, namaOrangTua) {
            ...
            document.getElementById('deleteOrangTuaName').textContent = namaOrangTua;
