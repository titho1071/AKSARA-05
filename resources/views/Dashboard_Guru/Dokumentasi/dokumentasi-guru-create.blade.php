...
<div class="mb-8">
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 px-4 py-2 pt-4">
        <div>
            <h1 class="text-3xl md:text-4xl font-bold text-gray-900">Tambah Data Dokumentasi Kegiatan</h1>
            <p class="text-gray-600 mt-1">Tambahkan data kegiatan beserta foto dokumentasinya.</p>
        </div>
