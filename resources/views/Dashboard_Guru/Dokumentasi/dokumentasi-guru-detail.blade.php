...
<div id="deleteModal" class="fixed inset-0 z-50 hidden items-center justify-center">
    ...
    <div class="relative w-full max-w-sm rounded-[28px] bg-white p-8 shadow-xl">
        ...
        <h2 class="mb-2 text-center text-lg font-bold text-slate-900">
            Hapus Kegiatan
        </h2>

        <p class="mb-1 text-center text-sm text-slate-500">
            Apakah kamu yakin ingin menghapus
        </p>

        <p id="deleteNama"
            class="mb-6 text-center text-sm font-semibold text-slate-800">
        </p>

        <p class="mb-6 text-center text-xs text-slate-400">
            Semua foto kegiatan juga akan ikut terhapus.
        </p>
