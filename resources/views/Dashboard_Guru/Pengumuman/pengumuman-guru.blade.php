...
<!-- Header Section -->
    <div class="mb-6 sm:mb-8">
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 py-2 pt-2">
            <div>
                ...
                <p class="text-gray-600 mt-1 text-sm sm:text-base">Kelola Pengumuman Kelas: <span class="font-semibold">{{ $namaKelas }}</span></p>
            </div>
            @if($kelasId)
            <a id="btn-add-pengumuman" href="{{ route('guru.pengumuman.create') }}" class="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white px-5 py-3 rounded-lg font-medium flex items-center justify-center gap-2 transition-colors min-h-[44px]">
    ...
    <div class="bg-white rounded-2xl p-4 sm:p-6 shadow-sm border border-gray-100">
        <div id="pengumuman-alert" class="hidden mb-4 sm:mb-6 rounded-lg border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-700"></div>
