    ...
    <form id="pengumuman-form" enctype="multipart/form-data">
        ...
        <div class="grid gap-6 md:grid-cols-2">
            ...
            <div class="md:col-span-2">
                ...
                <div id="current-file-info" class="mb-2 hidden">
                    <span class="text-sm text-gray-600">File saat ini: </span>
                    <a id="current-file-link" href="#" target="_blank" class="text-sm text-blue-600 hover:underline">Lihat Lampiran</a>
                </div>
                <input 
                    id="file" 
                    type="file" 
                ...
                <small class="text-gray-500 mt-2 block">
                    Format: JPG, JPEG, PNG, SVG, PDF — Maksimal 10 MB. Kosongkan jika tidak ingin mengubah file.
                </small>
            </div>
        </div>
