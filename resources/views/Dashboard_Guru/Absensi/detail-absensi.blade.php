...
<style>
    /* Kunci overflow horizontal hanya untuk halaman ini, tanpa mengubah layout utama */
    html, body {
        max-width: 100%;
    ...
    <div class="w-full max-w-full overflow-x-hidden space-y-8">
        ...
        <div class="w-full max-w-full rounded-[32px] bg-white p-6 shadow-[0_24px_60px_rgba(15,23,42,0.08)] overflow-hidden">
            <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                ...
                <a href="{{ route('guru.absensi.pilih-bulan', $kelas->id_kelas) }}" class="inline-flex shrink-0 items-center gap-2 text-sm font-semibold text-slate-700 hover:text-slate-900">
                        ...
                        <tr>
                            ...
                            @foreach ($days as $day)
                                <th class="border border-slate-700 px-1 py-3 text-center">
                                    <a
                                        href="{{ route('guru.absensi.kelola', [
                                            'id' => $kelas->id_kelas,
                                            'bulan' => $bulan,
                                            'tanggal' => $day
                                        ]) }}"
