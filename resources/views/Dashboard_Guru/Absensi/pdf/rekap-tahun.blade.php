...
<head>
    <meta charset="UTF-8">
    <style>
        body { font-family: Arial, times new roman; font-size: 12px; }
        .header { text-align: center; line-height: 1.5; margin-bottom: 20px; }
        .header h2 { margin: 0; }
        ...
        .info-left { flex: 1; }
        .info-left td { padding: 1px 0 !important; }
        .footer { margin-left: auto; margin-right: 0; width: max-content; text-align: center; margin-top: 40px; }
        .ttd { width: 150px; float: right; }
        .ttd p { margin: 5px 0; }
        .nama-guru { margin-top: 40px; }
    </style>
</head>
<body>
    ...
    <div class="info-left">
        <table>
            ...
            <tr>
                ...
                <td style="text-align:left;border:none;">:</td>
                <td style="text-align:left;border:none;">Juli {{ $tahunAwal }} – Juni {{ $tahunAkhir }}</td>
            </tr>
        </table>
    </div>
</div>
...
<div class="footer">
    <div class="ttd">
        ...
        <p>Wali Kelas</p>
        <div class="nama-guru">{{ $kelas->guru->nama ?? '-' }}</div>
    </div>
</div>
