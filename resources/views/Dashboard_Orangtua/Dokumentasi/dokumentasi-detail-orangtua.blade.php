...
<div class="mb-8">
    <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
            <p class="text-sm font-semibold text-gray-500">Dokumentasi</p>
            <h1 class="text-3xl font-bold text-gray-950">Detail Dokumentasi</h1>
            <p class="text-sm text-gray-500">Informasi lengkap kegiatan dari guru.</p>
        </div>
